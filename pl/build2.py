...
EXTRA_COGS = {
 ...
 "神栖横丁": ["仕入（ビーエム）","ALSOK","ウゴーク","クリーズコネクト（ゴミ）","ダスキン",
          ...
          "東総食肉センター","EMBER","藤本商会本店","その他、仕入（小口）"],
...
EXTRA_SGA = {
 ...
 "タコとハイボール": ["消耗品費（関彰商事）","雑費（本部SV巡回活動費）","支払手数料（出前館）",
                "支払手数料（出前館返金）","支払手数料（UberEats）","保険衛生費","ロイヤリティ"],
 "焼きたて屋": ["ごみ処分費","地代家賃（裏プレハブ賃料）","通信費（POSレジ）","通信費（POSレジ利用料）",
