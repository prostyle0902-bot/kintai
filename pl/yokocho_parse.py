...
2608月          /※請求書※/買掛/21期/2608月/<店舗>/（店舗ごとに名前がバラバラ）
                 2026-09-19 に届いた。21期の最終月。
...
ITEM2ROW = {
    ...
    "その他値引き": "その他経費",
    # ★2026-09-19 追加。2608月から4店舗そろって 慶弔費 1,000 が付くようになった。
    #   それまでは0でしか出てこなかったので ZERO_ONLY に入れていた。
    #   テナント会（入居店舗の会）の慶弔費。その他値引きと同じ「その他経費」に置いた。
...
# ★慶弔費は 2026-09-19 に ITEM2ROW へ移した（2608月から金額が付いた）
ZERO_ONLY = {"チャレンジショップ使用料", "テナント会雑費", "備品購入費代"}
