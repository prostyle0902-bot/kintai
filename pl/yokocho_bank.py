...
FROM_INVOICE = {
    ...
    ("デンワ７８", "7月"): 7534,
    # ★2026-09-01 に外した。ここに ("ＮＳ　ユウセン","6月"):2560 と 7月を入れていたが誤り。
    #   口座振替の「ＮＳ　ユウセン」は12か月きっかり5,830円（USENのBGM）で、
    #   請求書の USEN NETWORKS 1,280×2枚＝税抜2,560（USEN NET＝ネット回線）とは別物。
    #   止めてしまったせいで6月・7月のBGM 5,300 が落ちていた。
}
