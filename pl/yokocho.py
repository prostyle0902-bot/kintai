...
★手元に無いのは1か月ぶん
    ...
    2608月（9月末請求） … 2026-09-19 に4店舗ぶん届いた。21期の最終月。
      ファイル名は店舗ごとにバラバラ（2026年08月ハナ.pdf／タコハイ2026.8月.pdf など）。
      ★この月から「慶弔費 1,000」が4店舗そろって付くようになった。
        それまでは0だったので ZERO_ONLY に入れていた摘要。いまは「その他経費」へ。

--- 検算 -----------------------------------------------------------------
44枚とも「明細の合計＝小計」「小計の10%＝消費税（四捨五入）」
「小計＋消費税＝合計」を通している。
